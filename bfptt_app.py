...
BFPT_QUESTIONS = [
    {"id": 1,  "text": "Am the life of the party.", "hint": "I naturally energize social situations and enjoy being at the center of them."},
    {"id": 2,  "text": "Feel little concern for others.", "hint": "I don't often worry about what other people are going through."},
    {"id": 3,  "text": "Am always prepared.", "hint": "I like to plan ahead and have everything ready before I need it."},
    {"id": 4,  "text": "Get stressed out easily.", "hint": "Small problems or pressure tend to affect my mood or wellbeing quickly."},
    {"id": 5,  "text": "Have a rich vocabulary.", "hint": "I express myself well and comfortably use a wide range of words."},
    {"id": 6,  "text": "Don't talk a lot.", "hint": "I tend to be quiet and prefer listening over speaking in most situations."},
    {"id": 7,  "text": "Am interested in people.", "hint": "I enjoy learning about others' lives, thoughts, and experiences."},
    {"id": 8,  "text": "Leave my belongings around.", "hint": "I often leave my things out rather than putting them back in their place."},
    {"id": 9,  "text": "Am relaxed most of the time.", "hint": "I generally feel calm and don't get anxious or tense easily."},
    {"id": 10, "text": "Have difficulty understanding abstract ideas.", "hint": "I find it hard to grasp theoretical or philosophical concepts."},
    {"id": 11, "text": "Feel comfortable around people.", "hint": "Being with others feels natural and easy for me."},
    {"id": 12, "text": "Insult people.", "hint": "I sometimes say things that hurt or offend others, intentionally or not."},
    {"id": 13, "text": "Pay attention to details.", "hint": "I notice small things others might overlook and like to be thorough."},
    {"id": 14, "text": "Worry about things.", "hint": "I frequently find myself thinking about what might go wrong."},
    {"id": 15, "text": "Have a vivid imagination.", "hint": "My mind easily creates detailed mental images, stories, or ideas."},
    {"id": 16, "text": "Keep in the background.", "hint": "I prefer to stay unnoticed rather than stand out in social situations."},
    {"id": 17, "text": "Sympathize with others' feelings.", "hint": "When someone is sad or struggling, I genuinely feel for them."},
    {"id": 18, "text": "Make a mess of things.", "hint": "I tend to leave tasks or spaces disorganized or unfinished."},
    {"id": 19, "text": "Seldom feel blue.", "hint": "I rarely feel sad, down, or low in mood."},
    {"id": 20, "text": "Am not interested in abstract ideas.", "hint": "I prefer practical, concrete topics over theoretical discussions."},
    {"id": 21, "text": "Start conversations.", "hint": "I often initiate talking with others rather than waiting for them to speak first."},
    {"id": 22, "text": "Am not interested in other people's problems.", "hint": "I don't feel drawn to get involved in others' difficulties or concerns."},
    {"id": 23, "text": "Get chores done right away.", "hint": "I handle tasks and responsibilities promptly without putting them off."},
    {"id": 24, "text": "Am easily disturbed.", "hint": "Noise, interruptions, or unexpected changes tend to throw me off."},
    {"id": 25, "text": "Have excellent ideas.", "hint": "I often come up with creative, original, or useful solutions and thoughts."},
    {"id": 26, "text": "Have little to say.", "hint": "I often find I don't have much to contribute to conversations."},
    {"id": 27, "text": "Have a soft heart.", "hint": "I am easily moved by others' pain and tend to be gentle and compassionate."},
    {"id": 28, "text": "Often forget to put things back in their proper place.", "hint": "I frequently misplace items because I don't return them where they belong."},
    {"id": 29, "text": "Get upset easily.", "hint": "My emotions can shift quickly when things don't go as expected."},
    {"id": 30, "text": "Do not have a good imagination.", "hint": "I find it difficult to picture scenarios or come up with creative ideas."},
    {"id": 31, "text": "Talk to a lot of different people at parties.", "hint": "In social gatherings I move around and chat with many different people."},
    {"id": 32, "text": "Am not really interested in others.", "hint": "I don't find myself curious about other people's lives or feelings."},
    {"id": 33, "text": "Like order.", "hint": "I feel more comfortable when things are organized, tidy, and structured."},
    {"id": 34, "text": "Change my mood a lot.", "hint": "My emotional state shifts frequently throughout the day."},
    {"id": 35, "text": "Am quick to understand things.", "hint": "I grasp new information, instructions, or concepts quickly."},
    {"id": 36, "text": "Don't like to draw attention to myself.", "hint": "I feel uncomfortable being noticed or singled out in front of others."},
    {"id": 37, "text": "Take time out for others.", "hint": "I make time to check in on, help, or support the people around me."},
    {"id": 38, "text": "Shirk my duties.", "hint": "I sometimes avoid or delay responsibilities I'm supposed to handle."},
    {"id": 39, "text": "Have frequent mood swings.", "hint": "My emotions change rapidly and unpredictably on a regular basis."},
    {"id": 40, "text": "Use difficult words.", "hint": "I naturally incorporate advanced or complex vocabulary in my speech or writing."},
    {"id": 41, "text": "Don't mind being the center of attention.", "hint": "I feel at ease — or even enjoy it — when all eyes are on me."},
    {"id": 42, "text": "Feel others' emotions.", "hint": "I can sense what someone else is feeling, even if they haven't said anything."},
    {"id": 43, "text": "Follow a schedule.", "hint": "I plan my day and stick to a routine rather than acting spontaneously."},
    {"id": 44, "text": "Get irritated easily.", "hint": "Small annoyances or frustrations tend to bother me more than they should."},
    {"id": 45, "text": "Spend time reflecting on things.", "hint": "I regularly pause to think deeply about my experiences, thoughts, or decisions."},
    {"id": 46, "text": "Am quiet around strangers.", "hint": "I tend to hold back and say little when I'm around people I don't know."},
    {"id": 47, "text": "Make people feel at ease.", "hint": "Others tend to feel comfortable and relaxed when they're around me."},
    {"id": 48, "text": "Am exacting in my work.", "hint": "I hold myself to high standards and pay close attention to quality and accuracy."},
    {"id": 49, "text": "Often feel blue.", "hint": "I frequently experience feelings of sadness or low mood."},
    {"id": 50, "text": "Am full of ideas.", "hint": "My mind is constantly generating new thoughts, possibilities, and concepts."},
]
